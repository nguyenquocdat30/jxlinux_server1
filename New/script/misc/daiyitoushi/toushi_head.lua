...
TB_DAIYITOUSHI_FACTS = 					-- xxx
 ...
 {--xiaoyao
		...
		[60]	=	{1752},
		[70]	=	{1754,1753,},
		[90]	=	{{1755, 1, "Tiªu Dao CÇm"},{1774, 1, "Tiªu Dao KiÕm"},},
		[120]	=	{{1758, 1}},
		[150]	=	{{1760, 1, "Tiªu Dao CÇm"},{1775, 1, "Tiªu Dao KiÕm"},},

	},
			szMsg = "KÓ tõ h«m nay, %s gia nhËp Tiªu Dao §­êng, tham kiÕn c¸c s­ huynh s­ tû!",
