...
function main()
	...
	local aryDescribe =
	{
		...
		"Liªn Quan §Õn trang bŞ b¹ch kim/platina_main",
		-- "Ta muèn nhê l·o trïng luyÖn trang bŞ /trungluyentb",				
		-- "Ta muèn ®óng trang bŞ B¹ch Kim/recoin_platina_main",
		--Change request 04/06/2011, ®ãng chÕ t¹o trang bŞ b¹ch kim
	...
	--Trïng luyÖn Tö M·ng **blackcupid**
	--tbDailog:AddOptEntry("Ta muèn mêi ng­¬i trïng luyÖn trang bŞ Tö M·ng", tbVNG_RefineEquip.ShowDialog, {tbVNG_RefineEquip})	
...
-- Èç¹û½ÓÁËÍêÃÀ°²°îÈÎÎñ£¬²åÈëÑ¡Ïî
	...
	--if (check_nexttask_condition() == 1) then
		tinsert(aryDescribe, 2, "Ta muèn chÕ t¹o trang bŞ Hoµng Mü, An Bang, Trang søc/nexttask_talk");
	--end
	tinsert(aryDescribe, 2, "T¸i chÕ trang bŞ rµng buéc vÜnh viÔn/reclaimBindEquip_main");
