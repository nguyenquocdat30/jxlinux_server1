...
function wlls_award_pl_exp(n_rate, n_alevel)
	...
	local n_exp
	if n_rate == 3 then
		n_exp = 4000000 -- th¾ng nhËn ®c 4 TriÖu §iÓm kinh NghiÖm
		AddSkillState(451, 1, 0, 2*60*18)
	elseif n_rate == 2 then
		n_exp = 2000000 -- hßa nhËn ®c 2 TriÖu §iÓm kinh NghiÖm
	elseif n_rate == 1 then
		n_exp = 1000000 -- thua nhËn ®c 1 TriÖu §iÓm kinh NghiÖm
	end
	wlls_add_exp(n_exp)
