...
-- TL_MAXLINKSCOUNT = 4 -- Ã¿¸öÁ´×î¶àÖ»ÄÜ×ö 4 ´Îhoµn
...
ID_TASKLINK_LIMITNUM_done  = 5997;  -- ¼ÇÂ¼Ã¿ÌìÏŞÖÆµÄ´ÎÊı
...
local myLevel = GetLevel()
local myExp = GetExp()
local nNowExp = tonumber(TabFile_GetCell(TL_UPLEVELEXP,myLevel + 1,2)) -- µ±Ç°µÈ¼¶ËùĞèµÄ¾­Ñé
