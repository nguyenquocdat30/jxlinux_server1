...
local curCamp = nt_getCamp()
		...
		elseif ( Uworld1001 == 320 )  or ( Uworld1002 == 310 ) or ( Uworld1003 == 430 ) then  
						...
						if ( taskgoldenprize == 1 ) then
							if GoldenQuest_award ~= 1 then
								Talk(1,"","Minh Chñ Cã LÖnh SÏ Kh«ng Ph¸t Th­ëng §å Thiªn Hoµng, Ng­¬i H·y TiÕp Tôc §i Hoµn Thµnh NhiÖm Vô cßn l¹i §Ó NhËn §­îc C¸c Lo¹i Th­ëng Kh¸c")
							elseif GoldenQuest_award == 1 then
						...
						elseif ( taskgoldenprize == 2 ) then
							if GoldenQuest_award ~= 1 then
								Talk(1,"","Minh Chñ Cã LÖnh SÏ Kh«ng Ph¸t Th­ëng §å Thiªn Hoµng, Ng­¬i H·y TiÕp Tôc §i Hoµn Thµnh NhiÖm Vô cßn l¹i §Ó NhËn §­îc C¸c Lo¹i Th­ëng Kh¸c")
							elseif GoldenQuest_award == 1 then
								AddGoldItem(0,169)  --Ôö¼ÓÒ»¼ş»Æ½ğ×°±¸
							end
						elseif ( taskgoldenprize == 3 ) then
							if GoldenQuest_award ~= 1 then
								Talk(1,"","Minh Chñ Cã LÖnh SÏ Kh«ng Ph¸t Th­ëng §å Thiªn Hoµng, Ng­¬i H·y TiÕp Tôc §i Hoµn Thµnh NhiÖm Vô cßn l¹i §Ó NhËn §­îc C¸c Lo¹i Th­ëng Kh¸c")
							elseif GoldenQuest_award == 1 then
								AddGoldItem(0,170)  --Ôö¼ÓÒ»¼ş»Æ½ğ×°±¸
							end
						elseif ( taskgoldenprize == 4 ) then
							if GoldenQuest_award ~= 1 then
								Talk(1,"","Minh Chñ Cã LÖnh SÏ Kh«ng Ph¸t Th­ëng §å Thiªn Hoµng, Ng­¬i H·y TiÕp Tôc §i Hoµn Thµnh NhiÖm Vô cßn l¹i §Ó NhËn §­îc C¸c Lo¹i Th­ëng Kh¸c")
							elseif GoldenQuest_award == 1 then
								AddGoldItem(0,171)  --Ôö¼ÓÒ»¼ş»Æ½ğ×°±¸
							end
						elseif ( taskgoldenprize == 5 ) then
							if GoldenQuest_award ~= 1 then
								Talk(1,"","Minh Chñ Cã LÖnh SÏ Kh«ng Ph¸t Th­ëng §å Thiªn Hoµng, Ng­¬i H·y TiÕp Tôc §i Hoµn Thµnh NhiÖm Vô cßn l¹i §Ó NhËn §­îc C¸c Lo¹i Th­ëng Kh¸c")
							elseif GoldenQuest_award == 1 then
								AddGoldItem(0,172)  --Ôö¼ÓÒ»¼ş»Æ½ğ×°±¸
							end
						elseif ( taskgoldenprize == 6 ) then
							if GoldenQuest_award ~= 1 then
								Talk(1,"","Minh Chñ Cã LÖnh SÏ Kh«ng Ph¸t Th­ëng §å Thiªn Hoµng, Ng­¬i H·y TiÕp Tôc §i Hoµn Thµnh NhiÖm Vô cßn l¹i §Ó NhËn §­îc C¸c Lo¹i Th­ëng Kh¸c")
							elseif GoldenQuest_award == 1 then
								AddGoldItem(0,173)  --Ôö¼ÓÒ»¼ş»Æ½ğ×°±¸
							end
						elseif ( taskgoldenprize == 7 ) then
							if GoldenQuest_award ~= 1 then
								Talk(1,"","Minh Chñ Cã LÖnh SÏ Kh«ng Ph¸t Th­ëng §å Thiªn Hoµng, Ng­¬i H·y TiÕp Tôc §i Hoµn Thµnh NhiÖm Vô cßn l¹i §Ó NhËn §­îc C¸c Lo¹i Th­ëng Kh¸c")
							elseif GoldenQuest_award == 1 then
								AddGoldItem(0,174)  --Ôö¼ÓÒ»¼ş»Æ½ğ×°±¸
							end
						elseif ( taskgoldenprize == 8 ) then
							if GoldenQuest_award ~= 1 then
								Talk(1,"","Minh Chñ Cã LÖnh SÏ Kh«ng Ph¸t Th­ëng §å Thiªn Hoµng, Ng­¬i H·y TiÕp Tôc §i Hoµn Thµnh NhiÖm Vô cßn l¹i §Ó NhËn §­îc C¸c Lo¹i Th­ëng Kh¸c")
							elseif GoldenQuest_award == 1 then
								AddGoldItem(0,175)  --Ôö¼ÓÒ»¼ş»Æ½ğ×°±¸
							end
						elseif ( taskgoldenprize == 9 ) then
							if GoldenQuest_award ~= 1 then
								Talk(1,"","Minh Chñ Cã LÖnh SÏ Kh«ng Ph¸t Th­ëng §å Thiªn Hoµng, Ng­¬i H·y TiÕp Tôc §i Hoµn Thµnh NhiÖm Vô cßn l¹i §Ó NhËn §­îc C¸c Lo¹i Th­ëng Kh¸c")
							elseif GoldenQuest_award == 1 then
								AddGoldItem(0,176)  --Ôö¼ÓÒ»¼ş»Æ½ğ×°±¸
							end
						end
