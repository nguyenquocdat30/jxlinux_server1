...
Include("\\script\\global\\zid_jx\\global\\doidiemtongkim.lua")
...
function maintalk()
	--Say(str1..str2.."ÄãÓĞ<color=yellow>"..nt_getTask(747).."<color>×Ü»ı·Ö£¬ÓĞÊ²Ã´ĞèÒªÂğ£¿", 8,"ÎÒÒª¹ºÂòËÎ½ğµÀ¾ß/jinshop_sell","ÎÒÒªÓÃËÎ½ğ»ı·Ö»»È¡¾­Ñé/exp_exchange","¿´¿´ËÎ½ğÆÀ¼Û³ÆºÅ-ÌØÊâĞÎÏó/person_change","¿´¿´ËÎ½ğÆÀ¼Û³ÆºÅ-ÌØĞ§¹â»·/effect_aura","ÓÃÔÀÍõ»êÖ®Ê¯Á¶ÔìÔÀÍõ½£/yuewang_want","¹ºÂò»Æ½ğÍ¼Æ×/goldenitem_menu","¹ºÂòĞş¾§¿óÊ¯ºÍÊôĞÔ¿óÊ¯/ore","ÎÒÔÙ¿¼ÂÇ¿¼ÂÇ/no");	
	...
	tbDailog:AddOptEntry("Ta muèn ®æi ®iÓm kinh nghiÖm", doidiemexp)	
...
function exp_exchange()
	...
	if( GetLevel() < 40 ) then
		Talk( 1, "", "Qu©n Nhu quan: B¹n ch­a ®¹t ®­îc cÊp 40 kh«ng thÓ tham gia Phong V©n LuËn KiÕm, sao cã thÓ lÊy ®iÓm tİch lòy ®æi ®iÓm kinh nghiÖm?");
	else
...
function wantpayex(mark, nStep)
	...
	if( mark > nt_getTask(747) ) then
		Say("Qu©n Nhu quan: §iÓm tİch lòy cña b¹n kh«ng ®ñ.", 1, "§ãng/no");
	elseif (mark == 0) then
