...
function OnDeath( nNpcIndex )
	...
	if (rank == 6) then
		if (GetCurCamp() == 1) then
			Msg2MSAll(MISSIONID, "<color=yellow> Th竎h u Bang H閕 c玭g c竜: T鑞g qu﹏ "..GetName().."  gi誸 頲 Nguy猲 So竔 phe Kim!!!")
...
--			CloseMission(MISSIONID) 不立刻结束
			...
			Msg2MSAll(MISSIONID, "<color=yellow> Th竎h u Bang H閕 c玭g c竜: Kim qu﹏ "..GetName().."  gi誸 頲 Nguy猲 So竔 phe T鑞g!!!")
