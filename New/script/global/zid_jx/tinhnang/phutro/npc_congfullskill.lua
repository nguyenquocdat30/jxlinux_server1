...
------------------------------------------------------------------------------------------------------------
function CongfullskillMRQ()
-- dofile("script/global/general/thunghiem/npccongfullskill.lua")
dialog_main()
end

function dialog_main()
local szTitle = "<npc> Xin chµo <color=red>"..GetName().."<color> ! Ta lµ ng­êi hæ trî c¸c nh©n sÜ khi míi tham gia vµo <color=yellow>Vâ L©m TruyÒn Kú<color>. \n\n<color=green>Chó ý b¶o vÖ søc kháe vµ tµi s¶n khi ch¬i Game.<pic=115><color>"
tbOpt=
{
	{"Hæ Trî C«ng Full Skill", CongfullskillMRQ1},
	{"Th«i"},
}
...
tb_skill_add = {    [0] = { --thiÕu l©m
    ...
    [10] = { --Hoa s¬n
       [1] = {1347,1350,1349,1374,1375,1372,1351,1376,1354,1378,1355,1379,1358,1380,1360,1363,1382,1365,1368},
       [2] = {"Hoa S¬n KiÕm","KiÕm Ph¸p",1347,1349,1351,1354,1355,1360,1358},
       [3] = {"Hoa S¬n KhÝ","Ch­ëng ph¸p",1372,1374,1376,1379,1380,1358},
     },
  [11] = { --vu hon
       [1] = {1972,1964,1965,1963,1976,1980,1982,1971,1981,1974,1975,1977,1979},
       [2] = {"Vò Hån ThuÉn","ThuÈn Ph¸p",1972,1964,1965,1963,1976,1980,1982,1971,1981},
       [3] = {"Vò Hån §ao","§ao Ph¸p",1976,1980,1982,1971,1981,1974,1975,1977,1979},
     },
 [12] = { --Tiªu Dao
       [1] = {1904,1881,1882,1883,1885,1887,1888,1889,1890,1905,1906,1907,1909},
       [2] = {"Tiªu Dao KiÕm","KiÕm Ph¸p",1904,1881,1882,1883,1885,1887,1888,1889,1890},
       [3] = {"Tiªu Dao CÇm","Tiªu Dao CÇm",1888,1889,1890,1905,1906,1907,1909,1883},
     },		
}
NpcName = "<color=yellow>NPC Tù Céng Full Skill<color>: "
function dialog_main()
-- npcchat_npcmacdinh()
local szTitle = "<npc> Xin chµo <color=red>"..GetName().."<color> ! Chµo mõng ®Õn víi <color=yellow>Vâ L©m TruyÒn Kú HKMP PK<color>. \n\n<color=green>Chó ý b¶o vÖ søc kháe vµ tµi s¶n khi ch¬i Game.<pic=115><color>"
...
function add_magic(nFaction)
    ...
    elseif nFaction == 9 then
     ...
     elseif nFaction == 11 then
         nMonPhai = "Vò Hån §­¬ng Gia"	
     elseif nFaction == 12 then
         nMonPhai = "Tiªu Dao B¸ch BiÕn"
    end
...
---------------Cong tiem nang nhanh
function Congtiemnangnhanh()
