...
function main(sel)
	if NPCVanSuThong ~= 1 then
		return Talk(1,"","Minh Chñ Cã LÖnh Kh«ng ®­îc Cung CÊp Tin Tøc G× VÒ   Ng­êi Ch¬i Kh¸c, Vui Lßng Quay L¹i Sau.")
	end
	local tab_Content = {
		"Tèn 100000 l­îng b¹c ®Ó biÕt râ tin tøc vÒ mét ng­êi /Query1", 
