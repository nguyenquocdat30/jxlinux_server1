...
function InitMission()
	-- PhÇn th­ëng thêi gian tİch lòy khi kÕt thóc tèng kim - Author by AloneScript
...
-------------------------------------------------------------------------
	...
	--AddGlobalNews(str1);
	CreateChannel("Phe Tèng"..szGAME_GAMELEVEL.."D¹ng thøc Cõu s¸t", 9)
	CreateChannel("Phe Kim"..szGAME_GAMELEVEL.."D¹ng thøc Cõu s¸t", 10)
...
function EndMission()
	...
	-- PhÇn th­ëng thêi gian tİch lòy khi kÕt thóc tèng kim - Author by AloneScript
	BattleAward:GiveAward(MISSIONID);
	
	level = BT_GetGameData(GAME_LEVEL);
	DeleteChannel("Phe Tèng"..szGAME_GAMELEVEL.."D¹ng thøc Cõu s¸t")
	DeleteChannel("Phe Kim"..szGAME_GAMELEVEL.."D¹ng thøc Cõu s¸t")
...
function OnLeave(RoleIndex)
	...
	if (GetCurCamp() == 1) then
		LeaveChannel(PlayerIndex, "Phe Tèng"..szGAME_GAMELEVEL.."D¹ng thøc Cõu s¸t")
	else
		LeaveChannel(PlayerIndex, "Phe Kim"..szGAME_GAMELEVEL.."D¹ng thøc Cõu s¸t")
	end
	sf_onplayerleave()
