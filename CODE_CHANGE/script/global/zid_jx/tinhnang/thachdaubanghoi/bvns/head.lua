...
MS_MARSHAL = 2;--¼ÇÂ¼µ±Ç°²úÉúµÄÊÇËÎ¾üÔªË§£º1£»»¹ÊÇ½ð¾üÔªË§£º2£»»¹ÊÇ¶¼²úÉúÁË£º3£»
...
MS_MARSHALDEATH = 18	--Èç¹ûÒ»·½´ó½«ËÀÍö£¬ÔòÎª£º1£¨ËÎ£©»ñ2£¨½ð£©£»·ñÔòÎª£º0

MS_TOTALPOINT_S = 19		--±¾´ÎÕ½ÒÛ½áÊøÊ±ÇëÁã£¬¼ÇÂ¼±¾´ÎÕ½ÒÛËÎ·½×Ü»ý·Ö
MS_TOTALPOINT_J = 20		--±¾´ÎÕ½ÒÛ½áÊøÊ±ÇëÁã£¬¼ÇÂ¼±¾´ÎÕ½ÒÛ½ð·½×Ü»ý·Ö


FILE_HOMETRAP1 = "\\script\\global\\zid_jx\\tinhnang\\thachdaubanghoi\\bvns\\hometrap1.lua";
FILE_HOMETRAP2 = "\\script\\global\\zid_jx\\tinhnang\\thachdaubanghoi\\bvns\\hometrap2.lua";
FILE_CENTERTRAP = "\\script\\global\\zid_jx\\tinhnang\\thachdaubanghoi\\bvns\\centertrap.lua";
FILE_CENTERTOHOMETRAP1 = "\\script\\global\\zid_jx\\tinhnang\\thachdaubanghoi\\bvns\\homeouttrap1.lua"
FILE_CENTERTOHOMETRAP2 = "\\script\\global\\zid_jx\\tinhnang\\thachdaubanghoi\\bvns\\homeouttrap2.lua"

tabFILE_NPCDEATH = 
	{
	"\\script\\global\\zid_jx\\tinhnang\\thachdaubanghoi\\bvns\\npcdeath_1.lua",
	"\\script\\global\\zid_jx\\tinhnang\\thachdaubanghoi\\bvns\\npcdeath_2.lua",
	"\\script\\global\\zid_jx\\tinhnang\\thachdaubanghoi\\bvns\\npcdeath_3.lua",
	"\\script\\global\\zid_jx\\tinhnang\\thachdaubanghoi\\bvns\\npcdeath_4.lua",
	"\\script\\global\\zid_jx\\tinhnang\\thachdaubanghoi\\bvns\\npcdeath_5.lua",
...
FILE_DOCTOR1 = 	"\\script\\global\\zid_jx\\tinhnang\\thachdaubanghoi\\bvns\\doctor.lua";
FILE_DOCTOR2 = 	"\\script\\global\\zid_jx\\tinhnang\\thachdaubanghoi\\bvns\\doctor.lua";
FILE_SYMBOLNPC = ""
FILE_DEPOSIT = 	"\\script\\global\\zid_jx\\tinhnang\\thachdaubanghoi\\openbox.lua"
FILE_DEATH = "\\script\\global\\zid_jx\\tinhnang\\thachdaubanghoi\\bvns\\npcdeath.lua"
FILE_TRANSPORT1 = 	"\\script\\global\\zid_jx\\tinhnang\\thachdaubanghoi\\bvns\\transport.lua";
FILE_TRANSPORT2 = 	"\\script\\global\\zid_jx\\tinhnang\\thachdaubanghoi\\bvns\\transport.lua";
...
--	--Ä£Ê½×ÜÅÅÐÐ°ñ
	...
	-- ËÎ½ðµ÷Õû Èç¹ûÕ½Æ½Ôò¸ù¾Ý»ý·Ö¼ÆËãÊ¤¸º
	...
	if (nFinalWiner == 0) then
		resultstr = resultstr.."ChiÕn sù ®· kÕt thóc, c¶ 2 phe hßa nhau!"
		Msg2MSAll(MISSIONID, resultstr)
		WriteLog(resultstr)
		BT_ReportResult(0)
		sf_winbouns(0)
		BattleTong:EndGame(0);
		RecordBTCount_Win(0)		--ÔÚÃ¿¸öÈËÈÎÎñ±äÁ¿Àï¼ÇÂ¼Ëü´Ë´ÎËÎ½ðÕ½³¡Ê¤¸º×´¿ö
	...
	for i = 1 , 500 do 
 	...
 	for i= 1, getn(tbPlayer) do 
		...
		if (l_curcamp == 1) then
			SetRevPos(GAME_SIGNMAP, 1)
			NewWorld(bt_getsignpos(1))
		else	
			SetRevPos(GAME_SIGNMAP, 2)
...
if (result == 0) then
--§æi phÝ b¸o danh l¹i thµnh 1 TK chiªu binh lÖnh - Modified by DinhHQ - 20110504
...
gametime = floor(GetMSRestTime(MISSIONID, TOTALTIMER) / 18);
...
if (camp == 1) then
	...
	EnterChannel(PlayerIndex, "Phe Tèng"..szGAME_GAMELEVEL.."B¶o vÖ Nguyªn so¸i")
else
	posx = GetMissionV(MS_HOMEIN_X2)
	posy = GetMissionV(MS_HOMEIN_Y2)
	str = GetName().."Gia nhËp phe Kim"
	EnterChannel(PlayerIndex, "Phe Kim"..szGAME_GAMELEVEL.."B¶o vÖ Nguyªn so¸i")
end
...
SetPKFlag(1)
ForbidChangePK(1);
SetDeathScript("\\script\\global\\zid_jx\\tinhnang\\thachdaubanghoi\\bvns\\playerdeath.lua");
bt_JudgePLAddTitle()
end;
------------------------------------------------------------------
