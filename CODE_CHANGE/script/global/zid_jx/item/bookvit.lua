...
function main(nItemIndex)
	...
	SetTask(TASKID_BASEMORE_VIT,GetTask(TASKID_BASEMORE_VIT)+nPoint);
	AddVit(nPoint);
	AddProp(nPoint);
	Msg2Player(format("<color=green>B¹n ®· nhËn thªm %d ®iÓm <color=yellow>sinh khÝ<color>!<color>",nPoint));
