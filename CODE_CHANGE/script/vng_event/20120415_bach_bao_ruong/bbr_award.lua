...
tbBBRAward.tbProduct = {
	...
	["LanLenhKy"] = {
		{tbProduct = {szName="MÆt n¹ V­¬ng Gi¶",tbProp={0,11,561,1,0,0},nCount=1,nExpiredTime=10080}, nFlagRequire = 400},
		...
		{tbProduct = {szName="Phong V©n B¹ch M·",tbProp={0,10,19,1,0,0},nCount=1,nExpiredTime=10080}, nFlagRequire = 100, },
		{tbProduct = {szName="Phiªn Vò (HSD 1 th¸ng)",tbProp={0,10,7,1,0,0},nCount=1,nExpiredTime=10080}, nFlagRequire = 20},
		{tbProduct = {szName="Phiªn Vò (HSD 3 th¸ng)",tbProp={0,10,7,1,0,0},nCount=1,nExpiredTime=10080}, nFlagRequire = 60},
		{tbProduct = {szName="Vò §· Hµ",tbProp={0,3880},nCount=1,nQuality = 1,nExpiredTime=10080,}, nFlagRequire = 10},
		{tbProduct = {szName="Thanh B×nh L¹c",tbProp={0,3881},nCount=1,nQuality = 1,nExpiredTime=10080,}, nFlagRequire = 10},
		{tbProduct = {szName="Håi Xu©n",tbProp={0,3882},nCount=1,nQuality = 1,nExpiredTime=10080,}, nFlagRequire = 10},
		{tbProduct = {szName="Kh« Méc",tbProp={0,3883},nCount=1,nQuality = 1,nExpiredTime=10080,}, nFlagRequire = 10},
	...
	["PhungLenhKy"] = {
		...
		{tbProduct = {szName="Hoµng Kim Ên (C­êng hãa) cÊp 8",tbProp={0,3212},nCount=1,nQuality = 1,nExpiredTime=10080,}, nFlagRequire = 3000},
		{tbProduct = {szName="Hoµng Kim Ên (Nh­îc hãa) cÊp 7",tbProp={0,3221},nCount=1,nQuality = 1,}, nFlagRequire = 2000},
		{tbProduct = {szName="Hoµng Kim Ên (Nh­îc hãa) cÊp 8",tbProp={0,3222},nCount=1,nQuality = 1,nExpiredTime=10080,}, nFlagRequire = 3000},
		{tbProduct = {szName="Vò §· Hµ",tbProp={0,3880},nCount=1,nQuality = 1,nExpiredTime=10080,}, nFlagRequire = 10},
		{tbProduct = {szName="Thanh B×nh L¹c",tbProp={0,3881},nCount=1,nQuality = 1,nExpiredTime=10080,}, nFlagRequire = 10},
		{tbProduct = {szName="Håi Xu©n",tbProp={0,3882},nCount=1,nQuality = 1,nExpiredTime=10080,}, nFlagRequire = 10},
		{tbProduct = {szName="Kh« Méc",tbProp={0,3883},nCount=1,nQuality = 1,nExpiredTime=10080,}, nFlagRequire = 10},
