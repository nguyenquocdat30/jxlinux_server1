...
tbCurSeason.tbPrizeList = {		
	[1]={szName="Phiªn Vò (HSD 6 th¸ng)",tbProp={0,10,7,1,0,0},nCount=1,nExpiredTime=10080},
	...
	[5]={szName="Hoµng Kim Ên (C­êng hãa)",tbProp={0,3212},nCount=1,nQuality = 1,nExpiredTime=10080,},
	[6]={szName="Hoµng Kim Ên (Nh­îc hãa)",tbProp={0,3222},nCount=1,nQuality = 1,nExpiredTime=10080,},
	...
	[10]={szName="MÆt n¹ - Anh hïng chiÕn tr­êng",tbProp={0,11,482,1,0,0},nCount=1,nExpiredTime=10080,nUsageTime=-1},
	[11]={szName="Phi phong Ngù Phong (X¸c suÊt hãa gi¶i s¸t th­¬ng)",tbProp={0,3474},nCount=1,nQuality = 1,nExpiredTime=10080,},
	[12]={szName="Phi phong Ngù Phong (Träng kÝch)",tbProp={0,3475},nCount=1,nQuality = 1,nExpiredTime=10080,},
