...
WLLS_DATA = {
	...
	npc_mylg = function()
		...
		if (n_mytype ~= n_next) then
			str = str .. "<enter>   <color=yellow>Chó ı: H¹n chÕ thi ®Êu mïa sau lµ <color><color=red>"..WLLS_TAB[n_next].name.."<color><color=yellow>, nÕu muèn thi ®Êu mïa sau, xin h·y lËp chiÕn ®éi míi.<color><enter>"
		end
		local tb_option = {}
