...
tbTCMJ_Box_Award = 
{
	...
	["chiakhoavang"] = 
	{
		...
		{szName="Vò §· Hµ",tbProp={0,3880},nCount=1,nRate=0.5,nQuality = 1,nExpiredTime=10080,},
		{szName="Thanh B×nh L¹c",tbProp={0,3881},nCount=1,nRate=0.5,nQuality = 1,nExpiredTime=10080,},
		{szName="Håi Xu©n",tbProp={0,3882},nCount=1,nRate=0.5,nQuality = 1,nExpiredTime=10080,},
		{szName="Kh« Méc",tbProp={0,3883},nCount=1,nRate=0.5,nQuality = 1,nExpiredTime=10080,},
		{szName="L­u V©n ",tbProp={0,3884},nCount=1,nRate=0.5,nQuality = 1,nExpiredTime=10080,},
		{szName="Nª Tr¹ch",tbProp={0,3885},nCount=1,nRate=0.5,nQuality = 1,nExpiredTime=10080,},
		{szName="L«i Háa KiÕp",tbProp={0,3886},nCount=1,nRate=0.5,nQuality = 1,nExpiredTime=10080,},
		{szName="Mª Tóy Thiªn H­¬ng",tbProp={0,3887},nCount=1,nRate=0.5,nQuality = 1,nExpiredTime=10080,},
		{szName="§iÖp Vò Hoa Phi",tbProp={0,3888},nCount=1,nRate=0.5,nQuality = 1,nExpiredTime=10080,},		
		{szName="§iÓm kinh nghiÖm 1", 
					pFun = function (tbItem, nItemCount, szLogTitle)
