...
map_lnpc = {
	...
	-- 7
	{1, {4.5, 0, nil},
		{nil, 980, "ThÇn Tı ", 75, 3, 0, 24, func_npc_getpos}},
	-- 8
	{2,	{6, 10, nil},
	...
	-- 18
	{2,	{6, 10, nil},
		{nil, 980, "ThÇn Tı ", 75, func_npc_getseries, 0, 16, func_npc_getpos},
		{func_npc_proceed, func_npc_getid, func_npc_getname, 75, func_npc_getseries, 1, 1, {1568, 3227}}},
	-- 19
	{1,	{4.5, 0, nil},
	...
	-- 27
	{2, {24, 15, nil},
		{nil, 1006, "NhiÕp Thİ TrÇn", 75, -1, 0, 1, {1568, 3227}},
...
map_hnpc = {
	...
	-- 7
	{1, {5, 0, nil},
		{nil, 1012, "ThÇn Tı ", 95, 3, 0, 24, func_npc_getpos}},
	-- 8
	{2, {9, 15, nil},
	...
	-- 18
	{2, {12, 20, nil},
		{nil, 1012, "ThÇn Tı ", 95, func_npc_getseries, 0, 16, func_npc_getpos},
		{func_npc_proceed, func_npc_getid, func_npc_getname, 95, func_npc_getseries, 1, 1, {1568, 3227}}},
	-- 19
	{1, {6, 0, nil},
	...
	-- 27
	{2, {32, 32, nil},
		{nil, 1038, "NhiÕp Thİ TrÇn", 95, -1, 1, 1, {1568, 3227}},
...
map_hi_hidden_npc = {
	...
	-- ÌôÕ½¸ß¼¶Ê±¼äµÄÌôÕ½ÅÅĞĞ°ñÍæ¼Ò
	{1,	{0, 0, nil}, {nil, {1026, 1033}, {func_ladder_getname, 10180}, 75, -1, 1, 1, {1568, 3227}}}
};

-- Ğ¡Äôß±³¾ ºÍ ĞÂboss
map_new_Ncp = {
	[1] = {nil, 1673, "TiÓu NhiÕp Thİ TrÇn", 95, -1, 1, 1, {1568, 3227}},
...
-- ¸ß¼¶±ÈÈüÍ¨¹Ø½±Àø£ºÎå»¨¡¢¾­Ñé¡¢ÎïÆ·
map_haward_success = {
	hi_exp_award, 0, nil
};

-- Ëæ»ú½±Àø£¬Ëæ»ú»ùÊıÎª100000
map_random_awards = {
...
--	{0.00, 		{"´ó°×¾ÔÍè",		6, 1, 130, 1, 0, 0}},	-- ´ó°×¾ÔÍè
	...
	{0.0005, 	{"§Şnh Quèc Thanh Sa Tr­êng Sam",	0, 159}},				-- ¶¨¹úÖ®ÇàÉ´³¤ÉÀ
	{0.0005, 	{"§Şnh Quèc ¤ Sa Ph¸t Qu¸n",	0, 160}},				-- ¶¨¹úÖ®ÎÙÉ°·¢¹Ú
	{0.0005,		{"§Şnh Quèc Xİch Quyªn NhuyÔn Ngoa",	0, 161}},				-- ¶¨¹úÖ®³à¾îÈíÑ¥
	{0.0005,		{"§Şnh Quèc Tö §»ng Hé uyÓn",	0, 162}},				-- ¶¨¹úÖ®×ÏÌÙ»¤Íó
	{0.0005,		{"§Şnh Quèc Ng©n Tµm Yªu ®¸i",	0, 163}},				-- ¶¨¹úÖ®Òø²ÏÑü´ø
	{0.0001,	{"An Bang B¨ng Tinh Th¹ch H¹ng Liªn",0, 164}},				-- °²°îÖ®±ù¾§Ê¯ÏîÁ´
	{0.0001,	{"An Bang Cóc Hoa Th¹ch ChØ hoµn",0, 165}},				-- °²°îÖ®¾Õ»¨Ê¯Ö¸»·
	{0.0001,	{"An Bang §iÒn Hoµng Th¹ch Ngäc Béi",0, 166}},				-- °²°îÖ®Ìï»ÆÊ¯ÓñÅå
...
function add_npc(item)
	local npc_count = get_npc_count(item);			-- NPCÊıÁ¿
