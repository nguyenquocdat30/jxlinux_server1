...
TB_GIFT = {
	...
	--{0.288,		{"Tiªn Th¶o Lé ",6,1,71,0,0,0}},
	 {0.0002,	{"Nguyªn So¸i ChiÕn M·",	0,5321}},
	 {0.0002,	{"Nguyªn So¸i Quan Ên",	0,5291}},
	 {0.0002,	{"Nguyªn So¸i Trang Søc",	0,5301}},
	 {0.0002,	{"Nguyªn So¸i Phi Phong ",	0,5311}},
	 {0.0002,	{"Nguyªn So¸i MÆt N¹",	0,5331}},
}
function main(sel)
...
function award_item(item)
	if getn(item) == 3 then
		...
		Say("R­¬ng ®· qu¸ cò ! bªn trong kh«ng cßn l¹i g× ! .",0);
