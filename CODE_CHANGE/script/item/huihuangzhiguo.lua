...
function main(ItemIndex)
	...
	if ( GetTask(2313) >= FruitsOfGlory_nCount ) then
		local szMsg = format("<#>H«m nay b¹n ®· ¨n %d qu¶ Huy hoµng, vâ c«ng th¨ng tiÕn qu¸ nhanh dÔ g©y t¸c dông ph¶n nghÞch, ngµy mai h·y tiÕp tôc vËy.",FruitsOfGlory_nCount);
		Say(szMsg, 0)
		return 1
	end
