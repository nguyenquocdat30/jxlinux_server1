...
function main(nItemIndex)
	...
	-- ÔÀÍõ½£
	if P == 2340 then
		local tbAwardItem = {tbProp={4,195,1,1,0,0},nExpiredTime=10080}
	...
	-- ÑªÕ½ÁîÆì
	if P == 2401 then
		local tbAwardItem = {tbProp={6,1,2212,1,0,0},nExpiredTime=10080,}
		tbAwardTemplet:GiveAwardByList(tbAwardItem, "Më ra vËt phÈm mua ë Kú Tr©n C¸c");
		return 0;
	end	
	...
	if P == 2328 then -- M· bµi - XÝch thè
		local tbAwardItem = {tbProp={0,10,5,2,5,0},nExpiredTime=10080}
		tbAwardTemplet:GiveAwardByList(tbAwardItem, "NhËn ®­îc vËt phÈm!");
		return 0;
	end
	if P == 2329 then -- M· bµi - §Ých L«
		local tbAwardItem = {tbProp={0,10,5,4,5,0},nExpiredTime=10080}
		tbAwardTemplet:GiveAwardByList(tbAwardItem, "NhËn ®­îc vËt phÈm!");
		return 0;
	end
	if P == 2330 then -- M· bµi - TuyÖt ¶nh
		local tbAwardItem = {tbProp={0,10,5,8,5,0},nExpiredTime=10080}
		tbAwardTemplet:GiveAwardByList(tbAwardItem, "NhËn ®­îc vËt phÈm!");
		return 0;
	end
	if P == 2331 then -- M· bµi - ¤ V©n §¹p TuyÕt
		local tbAwardItem = {tbProp={0,10,5,6,5,0},nExpiredTime=10080}
		tbAwardTemplet:GiveAwardByList(tbAwardItem, "NhËn ®­îc vËt phÈm!");
		return 0;
	end
	if P == 2332 then -- M· bµi - ChiÕu D¹ Ngäc S­ Tö
		local tbAwardItem = {tbProp={0,10,5,10,5,0},nExpiredTime=10080}
		tbAwardTemplet:GiveAwardByList(tbAwardItem, "NhËn ®­îc vËt phÈm!");
		return 0;
	end
	...
	-- ±¼Ïü
	if P == 2333 then
		local tbAwardItem = {tbProp={0,10,6,1,5,0},nExpiredTime=10080}
		tbAwardTemplet:GiveAwardByList(tbAwardItem, "Më ra vËt phÈm mua ë Kú Tr©n C¸c");
		return 0;
	end

	if P == 2334 then -- M· bµi - Phiªn Vò
		local tbAwardItem = {tbProp={0,10,7,10,5,0},nExpiredTime=10080}
		tbAwardTemplet:GiveAwardByList(tbAwardItem, "NhËn ®­îc vËt phÈm!");
		return 0;
	end
	...
	-- ·ÉÔÆ
	if P == 2396 then
		local tbAwardItem = {tbProp={0,10,8,1,5,0},nExpiredTime=10080}
		tbAwardTemplet:GiveAwardByList(tbAwardItem, "Më ra vËt phÈm mua ë Kú Tr©n C¸c");
		return 0;
	end
	
	if P == 3416 then -- M· Bµi - Háa Tinh Kim Hæ V­¬ng
		local tbAwardItem = {tbProp={0,10,15,10,5,0},nExpiredTime=10080}
		tbAwardTemplet:GiveAwardByList(tbAwardItem, "NhËn ®­îc vËt phÈm!");
		return 0;
	end
		
	if P == 3483 or P == 4064 then -- M· Bµi - Siªu Quang
		local tbAwardItem = {tbProp={0,10,13,10,5,0},nExpiredTime=10080}
		tbAwardTemplet:GiveAwardByList(tbAwardItem, "NhËn ®­îc vËt phÈm!");
		return 0;
	end
...
function GetSeries(nP, nSeries)
	...
	-- Çå¾øÒÂ
	if nP == 2335 then
		local tbAwardItem = {tbProp={0,2,28,3,nSeries,0},nExpiredTime=10080}
		tbAwardTemplet:GiveAwardByList(tbAwardItem, "Më ra vËt phÈm mua ë Kú Tr©n C¸c");
		return
	end	
	...
	-- ±ù¾§È¹
	if nP == 2336 then
		local tbAwardItem = {tbProp={0,2,28,6,nSeries,0},nExpiredTime=10080}
		tbAwardTemplet:GiveAwardByList(tbAwardItem, "Më ra vËt phÈm mua ë Kú Tr©n C¸c");
		return
	end	
	...
	-- ¾ªÌì¼×
	if nP == 2337 then
		local tbAwardItem = {tbProp={0,2,28,2,nSeries,0},nExpiredTime=10080}
		tbAwardTemplet:GiveAwardByList(tbAwardItem, "Më ra vËt phÈm mua ë Kú Tr©n C¸c");
		return
	end	
	...
	-- ÆüµØÈ¹
	if nP == 2338 then
		local tbAwardItem = {tbProp={0,2,28,5,nSeries,0},nExpiredTime=10080}
		tbAwardTemplet:GiveAwardByList(tbAwardItem, "Më ra vËt phÈm mua ë Kú Tr©n C¸c");
		return
	end	
	...
	-- É±ÊÖïµ
	if nP == 2339 then
		local tbAwardItem = {tbProp={6,1,400,90,nSeries,0}, nCount = 2,nExpiredTime=10080}
		tbAwardTemplet:GiveAwardByList(tbAwardItem, "Më ra vËt phÈm mua ë Kú Tr©n C¸c");
		return
	end	
end
