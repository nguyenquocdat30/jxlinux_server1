...
tbAward_Ext = {
	...
	["awardspecial"] = { 
			...
			{szName="MÆt n¹ V­¬ng Gi¶",tbProp={0,11,561,1,0,0},nCount=1,nRate=1,nExpiredTime=10080, CallBack = _Message},	
		},
	["awardnomal"] ={ --Server cò vµ siªu quang
		...
		{szName="MÆt n¹ V­¬ng Gi¶",tbProp={0,11,561,1,0,0},nCount=1,nRate=0.05,nExpiredTime=10080, CallBack = _Message},
