...
Award_A = 
{
	...
	{szName="Hoµng Kim Ên (C­êng hãa)",tbProp={0,3210},nCount=1,nRate=0.2,nQuality = 1,nExpiredTime=10080,},
	{szName="Hoµng Kim Ên (Nh­îc hãa)",tbProp={0,3220},nCount=1,nRate=0.2,nQuality = 1,nExpiredTime=10080,},
	...
	{szName="MÆt n¹ Quû ¶nh",tbProp={0,11,455,1,0,0},nCount=1,nRate=1,nExpiredTime=10080},
