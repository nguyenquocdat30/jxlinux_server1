...
tbConfig[20] = --Ò»¸öÏ¸½Ú
{
	...
	tbActition = 
	{
		{"PlayerFunLib:GetItem",	{{tbProp={0,214},nQuality=1,nExpiredTime=10080,},1,"[WC 2010]GhÐp thµnh Vinh DiÖu Chi Y"} },
	},
}
tbConfig[21] = --Ò»¸öÏ¸½Ú
{
	...
	tbActition = 
	{
		{"PlayerFunLib:GetItem",	{{tbProp={0,215},nQuality=1,nExpiredTime=10080,},1,"[WC 2010]GhÐp thµnh Tinh ChuÈn Chi Ngoa"} },
	},
}
tbConfig[22] = --Ò»¸öÏ¸½Ú
{
