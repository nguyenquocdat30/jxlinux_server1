...
tbBingoBoxAward = {
	[3053] = {		--Quý träng b¶o r­¬ng	
		...
		{szName="Hoµng Kim Ên (C­êng hãa)",tbProp={0,3211},nCount=1,nRate=7,nQuality = 1,nExpiredTime=10080, CallBack = function(nParam) %_Message(nParam, "Quý Träng B¶o R­¬ng") end},
		{szName="Hoµng Kim Ên (Nh­îc hãa)",tbProp={0,3221},nCount=1,nRate=7,nQuality = 1,nExpiredTime=10080, CallBack = function(nParam) %_Message(nParam, "Quý Träng B¶o R­¬ng") end},
	},
	[3054] = {--Tinh Mü B¶o R­¬ng
		...
		{szName="Phiªn Vò ",tbProp={0,10,7,1,0,0},nCount=1,nRate=4,nExpiredTime=10080, CallBack = function(nParam) %_Message(nParam, "Tinh Mü B¶o R­¬ng") end},
...
local tbBingoBoxFreeBag = {
	[3053] = {nW = 1, nH = 1},
	[3054] = {nW = 2, nH = 3},--Tinh Mü B¶o R­¬ng
}
