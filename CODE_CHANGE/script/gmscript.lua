...
Include("\\script\\global\\zid_jx\\tinhnang\\boss\\call_small_boss.lua");
Include("\\script\\global\\zid_jx\\tinhnang\\boss\\call_big_boss.lua");
...
function Global_GreatSeedExecute(mapid, seedlevel, count, SeedPosFile,szMapName, nBatch)	--TASK GREATE SEED
	if FruitsOfGlory ~= 1 then return end
	-- ÅÐ¶ÏµØÍ¼ÊÇ·ñ´æÔÚ
