...
greatseed_configtab = {
	...
	-- {959,2,15,"\\settings\\maps\\great_night\\³¤°×É½±±Â´.txt","ChiÕn Long §éng"},	-- ³¤°×É½±±¢´
...
function TaskShedule()
	...
	TaskCountLimit(0)
	OutputMsg("=====> HOAT DONG QUA HUY HOANG BAT DAU LUC 18h30 PM");
end
...
function TaskContent()
	...
	if righttime_add() ~= 1 then--Èç¹ûÊ±¼ä²»¶Ô
		...
		gb_SetTask("QUA HUY HOANG", 19, 30);	--12ºÅ±äÁ¿ÓÃÀ´´æ´¢NPCµÄÐòºÅ
		return
	end;
