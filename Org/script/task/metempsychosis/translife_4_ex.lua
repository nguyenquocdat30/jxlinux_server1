...
TRANSLIFE_TIME = 4
TRANSLIFE_LEVEL = 200
SKILL_NAME = "ChiÕn ý Thiªn Thu"
SKILL_ID = 1171
SKILL_LEVEL = 1

function beidou_learn_specialskill()
	local szTitle = format("ChØ cã nh÷ng ®¹i hiÖp nµo kiªn tr×  <color=yellow>%d<color> trïng sinh cÊp <color=yellow>%d<color> lÇn míi cã thÓ häc ®­îc vâ c«ng bÝ truyÒn t¹i chç cña ta ®©y! ",TRANSLIFE_LEVEL,TRANSLIFE_TIME)
	local tbOpt = {}
	tinsert(tbOpt, {"X¸c ®Þnh muèn häc kü n¨ng",sureLearnSpecialSkill,{PlayerIndex}})
