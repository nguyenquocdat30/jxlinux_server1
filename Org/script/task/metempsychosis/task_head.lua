...
TB_LEVEL_LIMIT = {200, 200, 200, 200, 200, 200, 200}
TB_TRANSTIME_LIMIT = {0, 0, 0, 0, 0, 0, 0}
TBITEMNEED_4 = {
...
TB_TRANSLIFE_ERRORMSG = {
	...
	[7] = "<dec><npc>Bæc ß»u Tr≠Íng Sinh ThuÀt - T©m Ph∏p Thi™n nhi“u nh t chÿ c„ th” tu luy÷n 7 t«ng, ng≠¨i Æ∑ h‰c ÆÒ rÂi.",
...
TSK_ZHUANSHENG_GRE = {2577, 2578, 2579, 2583}
