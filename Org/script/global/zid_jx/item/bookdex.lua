...
function main(nItemIndex)
	...
	SetTask(TASKID_BASEMORE_DEX,GetTask(TASKID_BASEMORE_DEX)+nPoint);
	AddDex(nPoint);
	AddProp(nPoint);
	Msg2Player(format("<color=green>B¹n ®· nhËn thªm %d ®iÓm <color=yellow>th©n ph¸p<color>!<color>",nPoint));
