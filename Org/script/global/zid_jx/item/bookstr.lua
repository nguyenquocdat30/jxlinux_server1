...
function main(nItemIndex)
	...
	SetTask(TASKID_BASEMORE_STR,GetTask(TASKID_BASEMORE_STR)+nPoint);
	AddStrg(nPoint);
	AddProp(nPoint);
	Msg2Player(format("<color=green>B¹n ®· nhËn thªm %d ®iÓm <color=yellow>søc m¹nh<color>!<color>",nPoint));
