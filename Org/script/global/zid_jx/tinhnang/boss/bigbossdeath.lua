...
local tbVnNewItemDropAward = {
	{{szName="bao ruong do xanh",tbProp={6,1,4413,1,0,0},nCount=5,nRate=100},}, 
	{{szName="tien dong",tbProp={4,417,1,0,0},nCount=5,nRate=100},},
	...
	{{szName="Lam Thñy Tinh",tbProp={4,238,1,1,0,0},nCount=1,nRate=20},},
	{{szName="Lôc Thñy Tinh",tbProp={4,240,1,1,0,0},nCount=1,nRate=20},},
	{{szName="Bµn Nh­îc T©m Kinh",tbProp={6,1,12,1,0,0},nCount=2,nRate=80},},
	{{szName="Tinh Hång B¶o Th¹ch",tbProp={4,353,1,1,0,0},nCount=2,nRate=20},},
	{{szName="Tiªn Th¶o Lé ®Æc biÖt",tbProp={6,1,1181,1,0,0},nCount=2,nRate=20},},
	{{szName="Tiªn Th¶o Lé ",tbProp={6,1,71,1,0,0},nCount=1,nRate=20},},
	--{{szName="ThiÕt La H¸n",tbProp={6,1,23,1,0,0},nCount=2,nExpiredTime=20160,		nRate=100},},
	...
	--{{szName = "An Bang B¨ng Tinh Th¹ch H¹ng Liªn",tbProp = {0,random(164,167)},nCount = 1,nRate =0.1,nQuality = 1,},},
...
--====================================-----
	...
	KILLER_AWARDEXP_PERSON = 100000;
	/*[[   Th­ëng Exp GÇn Boss   ]]*/
	KILLER_AWARDEXP_NEARBY = 200000;
...
function OnDeath(nNpcIndex, nPlayerIndex)
	...
	AddDropItemBlue(nNpcIndex,totaldrop,nNpcSeries,leverdrop,random(50,80));
...
--function Msg2AllWorld(szNews)
	--RemoteExc("\\script\\msg2zid.lua", "Msg2AllWolrd", {szNews})
--end
