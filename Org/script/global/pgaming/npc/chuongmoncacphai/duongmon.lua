...
function oldentence()
	...
	if (UTask_tm == 70*256) and (GetFaction() == "tangmen") then
		SetFaction("")
		Say("HÖ thèng ph¸t hiÖn sai sãt, ®· kŞp thêi håi phuc!",0)
		return
	elseif (UTask_tm == 70*256) and (GetTask(10) >= 5*256) and (GetTask(10) < 10*256) then
		SetTask(10,0)
		Say("HÖ thèng ph¸t hiÖn sai sãt, ®· kŞp thêi håi phuc!",0)
		return
	elseif (UTask_tm == 80*256) and (GetCamp() == 4) then
		SetTask(2,70*256)
		Say("HÖ thèng ph¸t hiÖn sai sãt, ®· kŞp thêi håi phuc!",0)
		return
	...
	local tbDes = {
		"N©ng cÊp Trang BŞ TuyÖt §Ønh §­êng M«n/#tbHKUpgrade:DuongMon()",
		"N©ng cÊp Ên TuyÖt §Ønh §­êng M«n/#tbAnUpgrade:DuongMon()",
		"§¸i nghÖ ®Çu s­/#daiyitoushi_main(2)",
...
function common_talk()
	...
	elseif (Uworld51 == 80) and (HaveItem(377) == 1) then
	...
	elseif (GetFaction() == "tangmen") and (GetSeries() == 1) then
		if ((UTask_tm >= 20*256+60) and (UTask_tm <= 20*256+70) and (HaveItem(41) == 1)) then
		...
		elseif (UTask_tm == 60*256+60) and (HaveItem(49) == 1) then
		...
		elseif ((UTask_tm == 60*256) and (GetLevel() >= 50) and (GetFaction() == "tangmen")) then
	...
	elseif (GetSeries() == 1) and (GetCamp() == 4) and (GetLevel() >= 60) and (UTask_tm == 70*256) and (GetTask(10) < 5*256) then
		Say("LÇn nµy trë vÒ, ng­¬i muèn quay l¹i §­êng M«n sao?",2,"Tu©n lÖnh!/return_yes","Kh«ng. /return_no")
	elseif (GetCamp() == 4) and ((UTask_tm == 70*256+10) or (UTask_tm == 70*256+20)) then
	...
	elseif (UTask_tm == 70*256) and (GetFaction() ~= "tangmen") then
...
function check_skill()
	...
	if (GetFaction() == "tangmen") and (GetTask(2) == 80*256) and (HaveMagic(253) == -1) then
		AddMagic(253)
...
function defection_yes()
	...
	i=43 x = HaveMagic(i) if (x ~= -1) then n = n + x end DelMagic(i)
	i=44 x = HaveMagic(i) if (x ~= -1) then n = n + x end DelMagic(i)
	i=47 x = HaveMagic(i) if (x ~= -1) then n = n + x end DelMagic(i)
	i=48 x = HaveMagic(i) if (x ~= -1) then n = n + x end DelMagic(i)
	i=50 x = HaveMagic(i) if (x ~= -1) then n = n + x end DelMagic(i)
	i=51 x = HaveMagic(i) if (x ~= -1) then n = n + x end DelMagic(i)
	i=54 x = HaveMagic(i) if (x ~= -1) then n = n + x end DelMagic(i)
	i=55 x = HaveMagic(i) if (x ~= -1) then n = n + x end DelMagic(i)
	i=57 x = HaveMagic(i) if (x ~= -1) then n = n + x end DelMagic(i)
	i=58 x = HaveMagic(i) if (x ~= -1) then n = n + x end DelMagic(i)
	i=249x = HaveMagic(i) if (x ~= -1) then n = n + x end DelMagic(i)
	i=253x = HaveMagic(i) if (x ~= -1) then n = n + x end DelMagic(i)
	AddMagicPoint(n)
	SetTask(10,5*256+20)
	SetTask(2,75*256)
	SetRank(66)
