...
function oldentence()
	...
	if (UTask_tr == 70*256) and (GetFaction() == "tianren") then
		SetFaction("")
		Say("HÖ thèng ph¸t hiÖn sai sãt, ®· kŞp thêi håi phuc!",0)
		return
	elseif (UTask_tr == 70*256) and (GetTask(8) >= 5*256) and (GetTask(8) < 10*256) then
		SetTask(8,0)
		Say("HÖ thèng ph¸t hiÖn sai sãt, ®· kŞp thêi håi phuc!",0)
		return
	elseif (UTask_tr == 80*256) and (GetCamp() == 4) then
		SetTask(4,70*256)
		Say("HÖ thèng ph¸t hiÖn sai sãt, ®· kŞp thêi håi phuc!",0)
		return
	...
	local tbDes = {
		"N©ng cÊp Trang BŞ TuyÖt §Ønh Thiªn NhÉn/#tbHKUpgrade:ThienNhan()",
		"N©ng cÊp Ên TuyÖt §Ønh Thiªn NhÉn/#tbAnUpgrade:ThienNhan()",
		"§¸i nghÖ ®Çu s­/#daiyitoushi_main(7)",
...
function common_talk()
	...
	elseif (GetSeries() == 3) and (GetFaction() == "tianren") then
		if (UTask_tr == 60*256) and (GetLevel() >= 50) then
		...
		elseif (UTask_tr == 60*256+70) and (HaveItem(132) == 1) then
		...
		elseif (UTask_tr >= 60*256+50) and (UTask_tr <= 60*256+70) then
...
function defection_yes()
	n = 0
	i=135 x = HaveMagic(i) if (x ~= -1) then n = n + x end DelMagic(i)
	i=131 x = HaveMagic(i) if (x ~= -1) then n = n + x end DelMagic(i)
	i=132 x = HaveMagic(i) if (x ~= -1) then n = n + x end DelMagic(i)
	i=134 x = HaveMagic(i) if (x ~= -1) then n = n + x end DelMagic(i)
	i=136 x = HaveMagic(i) if (x ~= -1) then n = n + x end DelMagic(i)
	i=137 x = HaveMagic(i) if (x ~= -1) then n = n + x end DelMagic(i)
	i=138 x = HaveMagic(i) if (x ~= -1) then n = n + x end DelMagic(i)
	i=139 x = HaveMagic(i) if (x ~= -1) then n = n + x end DelMagic(i)
	i=140 x = HaveMagic(i) if (x ~= -1) then n = n + x end DelMagic(i)
	i=141 x = HaveMagic(i) if (x ~= -1) then n = n + x end DelMagic(i)
	i=142 x = HaveMagic(i) if (x ~= -1) then n = n + x end DelMagic(i)
	i=143 x = HaveMagic(i) if (x ~= -1) then n = n + x end DelMagic(i)
	i=145 x = HaveMagic(i) if (x ~= -1) then n = n + x end DelMagic(i)
	i=146 x = HaveMagic(i) if (x ~= -1) then n = n + x end DelMagic(i)
	i=147 x = HaveMagic(i) if (x ~= -1) then n = n + x end DelMagic(i)
	i=148 x = HaveMagic(i) if (x ~= -1) then n = n + x end DelMagic(i)
	i=149 x = HaveMagic(i) if (x ~= -1) then n = n + x end DelMagic(i)
	i=150 x = HaveMagic(i) if (x ~= -1) then n = n + x end DelMagic(i)
	i=254 x = HaveMagic(i) if (x ~= -1) then n = n + x end DelMagic(i)
	AddMagicPoint(n)
	SetTask(8,5*256+20)
	SetTask(4,75*256)
	SetRank(71)
