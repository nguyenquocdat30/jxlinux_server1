...
TSKID_FIRE_SUMEXP = 1869
TSKID_PLAYER_OLDRANK = 1862	--»ñµÃµÄ¾­ÑéÖµ
...
tbPlAYERER_ZHANGONG = {     0,  500,   1000,  2000,  4000} --´óÓÚ0ÎªÊ¿±ø£¬´óÓÚ300ÎªÐ£Î¾....
...
tbKILLNPC_AWARD = {2, 4, 6, 10, 16, 26, 0}	--É±ËÀnpc»ñµÃÕ½¹¦ (Soldier, Captain, Vanguard, General, Boss, Tank, Treasure)
tbKILLNPC_SHAREAWARD = {1, 1, 2, 3, 5, 8, 0}--¶ÓÓÑ»ñµÃÕ½¹¦
tbFILE_NPCDEATH = 
	{
	"\\script\\missions\\newcitydefence\\npcdeath_1.lua",
	"\\script\\missions\\newcitydefence\\npcdeath_2.lua",
...
LASTREPORT_TIME = (ThoiGianThuThanhPHLT - 20) * 60 * FRAME2TIME / SMALL_TIME;	--thêi gian c¶nh b¸o


CALLBOSS_ZHUSHUAI = (ThoiGianThuThanhPHLT - 5) * 60 * FRAME2TIME / SMALL_TIME;	--thoi gian boss xuat hien
