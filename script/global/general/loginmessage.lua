...
function LoginMessage()
	local nCamNangDongHanhCount = CalcEquiproomItemCount(6,1,4903,-1)
	if (nCamNangDongHanhCount and nCamNangDongHanhCount > 0) then
		ConsumeEquiproomItem(nCamNangDongHanhCount,6,1,4903,-1)
	end
