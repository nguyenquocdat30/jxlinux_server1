...
function sureClearSkillPoint_4()
	...
	for i=1,getn(TB_SKILL_4) do
		if HaveMagic(TB_SKILL_4[i][1]) > 0 then
			SetSkillLevel(TB_SKILL_4[i][1],TB_SKILL_4[i][2])
		end
	end
	...
	CreateTaskSay({format("<dec><npc>Ng­¬i ®· tÈy thµnh c«ng ®iÓm kü n¨ng chuyÓn sinh 4, hiÖn t¹i ng­¬i cã thÓ sö dông ®iÓm kü n¨ng chuyÓn sinh 4 d­ l¹i lµ %d, ®· sö dông lµ %d ®iÓm", nLeaveSkillPoint, nUsedSkillPoint), "BiÕt råi/OnCancel"})
