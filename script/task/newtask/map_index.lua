...
local myMapID, myMapName, myMapX, myMapY
	...
	if (myMapName ~= 0) then
		Say("C¸c h¹ muèn ®Õn khu vùc lµm nhiÖm vô D· TÈu ".."<color=yellow>"..myMapName.."<color>".." ­? Ta sÏ ®­a ®i miÔn phÝ!",2,"§óng vËy! Mau ®­a ta ®i!/tl_moveToTaskMap_Confirm","Th«i khái! Ta cßn viÖc kh¸c!/tl_moveToTaskMap_Cancel");
	else
